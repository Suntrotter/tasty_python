                ...
                <article className="admin-section-card" key={section.id}>
                  ...
                  {sortedBlocks.length > 0 ? (
                    ...
                    <div className="empty-progress-card">
                      <h3>No blocks yet.</h3>
                      <p>
                        This section will use legacy content until at least one
                        block is added in the Flexible section blocks editor.
                      </p>
                    </div>
                  )}
                  ...
                  {showLegacyEditor && hasLegacyContent && (
                    <div className="admin-legacy-summary">
                      ...
                      <ul>
                        ...
                        <li>
                          Image: {section.imageUrl ? section.imageUrl : "no"}
                        </li>
      ...
      {showLegacyEditor && (
        <section className="admin-edit-panel">
          ...
          <p className="api-notice">
            Importing will replace the current lesson content sections, items,
            and tables for this lesson.
          </p>
...
...`}
      ...
      {showLegacyEditor && (
        <section className="admin-edit-panel">
          ...
          <p className="admin-help-text">
            Update an existing item, including its optional image and
            after-text.
          </p>
      ...
      {showLegacyEditor && (
        <section className="admin-edit-panel">
          ...
          <p className="admin-help-text">
            Add or replace a table for a section. Headers and row cells are
            split with the pipe character.
          </p>
